...
public class StackWidget extends AppWidgetProvider {
    ...
    public static final String TOAST_ACTION = "com.donnipra.dicodingsub4.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.donnipra.dicodingsub4.EXTRA_ITEM";
