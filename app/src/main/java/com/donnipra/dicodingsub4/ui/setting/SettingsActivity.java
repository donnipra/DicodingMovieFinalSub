package com.donnipra.dicodingsub4.ui.setting;

/*
 * Created by donni.
 * Last modified 6/13/18 6:05 AM.
 */
...
import com.donnipra.dicodingsub4.util.AlarmReceiver;
import com.donnipra.dicodingsub4.util.SchedulerTask;
    ...
    public class MyPreferenceFragment extends PreferenceFragment implements Preference.OnPreferenceChangeListener, Preference.OnPreferenceClickListener {
        ...
        public boolean onPreferenceChange(Preference preference, Object o) {
            ...
            if (key.equals(reminder_daily)) {
                if (isOn) {
                    alarmReceiver.setRepeatingAlarm(getActivity(), alarmReceiver.TYPE_REPEATING, "07:50", getString(R.string.label_alarm_daily_reminder));
                } else {
